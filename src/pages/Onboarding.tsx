...
const Onboarding = () => {
  ...
  const [step, setStep] = useState<"names" | "invite">("names");
  ...
  return (
    <main className="min-h-screen bg-gradient-soft">
      <section className="mx-auto max-w-md px-4 py-10">
        ...
        <h1 className="mb-2 text-center text-2xl font-semibold text-olive-dark">
          {step === "names" ? "Welcome! Let's set up Olive" : "Connect with your partner"}
        </h1>
        <p className="mb-6 text-center text-muted-foreground">
          {step === "names" ? "We'll personalize your space. You can change these anytime." : "Invite your partner to share your Olive space."}
        </p>
