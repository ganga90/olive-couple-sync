-- Update RLS policies to use the standard Clerk integration approach
-- Remove the custom function and use auth.jwt() directly

-- Drop the custom function
DROP FUNCTION IF EXISTS public.get_clerk_user_id();

-- Update clerk_couples policies to use standard auth.jwt()->>'sub'
