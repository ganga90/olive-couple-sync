...
- "chat": User wants conversational interaction — briefings, motivation, planning, greetings, OR ASSISTIVE HELP with a task. This includes:
  ...
  - **ASSISTIVE (chat_type="assistant")**: When the user asks Olive to HELP THEM with a creative, compositional, or analytical task. The KEY signal: the user wants Olive to PRODUCE content FOR THEM, COLLABORATE on something, THINK THROUGH a problem, or ADVISE on a decision — not just save a note. Assistive intent covers a WIDE range:
    - **Drafting/Writing**: "Help me draft an email to my boss", "Write a message to congratulate Sara", "Puoi prepararmi una bozza?", "Aiutami a scrivere una risposta", "Prepara un testo per invitare i colleghi"
    - **Planning/Strategy**: "Help me plan my trip to Rome", "What's the best way to organize the move?", "Help me think through this decision", "Can you help me figure out the budget for the renovation?"
    - **Brainstorming/Ideas**: "I need ideas for Mom's birthday gift", "Help me come up with a meal plan for the week", "Brainstorm date night ideas", "What should I cook for the dinner party?"
    - **Advice/Analysis**: "What do you think about this job offer?", "Help me compare these two options", "I need your opinion on...", "Should I go with option A or B?"
    - **Research summaries**: "Summarize the pros and cons of X", "Help me understand the differences between...", "Break down the costs of..."
    - **Templates/Formats**: "Help me write a thank you note", "Draft a complaint letter", "Write a resignation email", "Prepare talking points for the meeting"
    - **Long conversational messages** (>100 chars) that are clearly asking Olive for help with something complex, NOT saving a task
    - Messages where the user says "ci pensi tu?", "can you handle this?", "take care of this", "help me with", "puoi aiutarmi", "me ayudas con"
  ...
  **CRITICAL DISTINCTION from create**: If a long message (>100 chars) asks Olive to DO something for them (draft, plan, brainstorm, advise, compare, analyze) rather than just REMEMBER something, it is "chat" (assistant), NOT "create". Brain dumps are short, factual notes. Assistive requests are conversational, collaborative, and ask for Olive's intelligence.
...
- "web_search": User wants EXTERNAL information from the web — booking links, reviews, directions, prices, availability, or any information NOT already in their saved data. This ALSO includes **GENERAL KNOWLEDGE QUESTIONS** — questions about the world, recommendations, opinions, comparisons, "best of" lists, factual questions that require real-world knowledge. Examples: "what are the best cities in Italy?", "best restaurants in Miami", "can you give me the link to book it?", "search for more information on X", "find me reviews for Y", "what's the address of Z?", "how do I get there?", "is it open now?", "find me a link", "look it up online", "search the web for X", "what's the weather like in Rome?", "what are good date ideas in New York?", "best hiking trails near Denver", "top 10 things to do in Barcelona", "how much does a flight to London cost?", "what are the best neighborhoods in Austin?", "recommend a good Italian restaurant". IMPORTANT: If the user asks a general knowledge question (even if some words match saved items), classify as "web_search" — the answer requires WORLD KNOWLEDGE, not just their saved data. The key test: could this question be answered by a search engine? If yes → web_search. If it can ONLY be answered by looking at the user's saved items → contextual_ask.
