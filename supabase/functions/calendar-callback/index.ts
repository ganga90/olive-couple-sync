...
serve(async (req) => {
  ...
  try {
    ...
    console.log('[calendar-callback] Got user info:', maskEmail(userInfo.email));
    ...
    console.log('[calendar-callback] Using primary calendar alias for', maskEmail(userInfo.email));
