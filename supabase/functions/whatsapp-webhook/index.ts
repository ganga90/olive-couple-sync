...
// trust gate, Meta direct send with template fallback). TASK_ACTION
// extraction is deferred to a follow-up PR (1.7b) because its
// 1,191-line block needs sub-handler decomposition.
